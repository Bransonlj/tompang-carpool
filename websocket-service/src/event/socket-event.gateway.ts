...
import { SendSocketEventDto } from "./dto/send-socket-event.dto";
...
export class SocketEventGateway implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect {
  ...
  public sendSocketEvent(sendSocketEventDto: SendSocketEventDto) {
    this.server.to(sendSocketEventDto.targetUserId).emit(sendSocketEventDto.eventName, sendSocketEventDto.payload);
  }
