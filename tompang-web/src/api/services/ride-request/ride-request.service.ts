...
export async function getRideRequestsByUser(userId: string): Promise<RideRequestSummary[]> {
  return [
    {
      id: "123",
...
export async function getRideRequestById(requestId: string): Promise<RideRequestDetail> {
  if (requestId === "456") {
    return {
      id: "456",
      originAddress: "green tower block 44 upper low street",
