...
public class UserProfileProjector {
  ...
  @KafkaListener(topics = KafkaTopics.Driver.DRIVER_REGISTRATION_SUCCEEDED, groupId = "profile-service")
  public void handleDriverRegistered(DriverRegistrationSucceededEvent event) {
